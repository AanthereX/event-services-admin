...
const ReviewsAndRatingTableVenues = ({
  selectedTab,
  pageData = {},
  setEdit = () => {},
  setShowDeleteModal = () => {},
        ...
        renderItem={(item, index, pageNumber) => {
          return (
            ...
            >
              ...
              <td className="min-w-20 whitespace-nowrap px-3 py-2 font-outfit_regular text-c_202224">
                {item?.events?.name ?? labels.notAvailable}
              </td>
              <td className="min-w-20 px-3 whitespace-nowrap py-2 font-outfit_regular text-c_202224">
                {item?.venue?.name ?? labels.notAvailable}
              </td>
              <td
...
export default ReviewsAndRatingTableVenues;
