...
const ServiceCategoryTable = ({
  ...
  const { ChevronRight, EditIcon, deleteIconRedWithoutBg } = Icons;

  return (
    <div>
      <Table
        headers={labels?.serviceCategoriesHeader}
        notFoundTitle={labels?.noServiceCategoryFound}
        notFoundDescription={labels?.noServiceCategoryDiscription}
        listData={categories}
        loading={loading}
        pageData={pageData}
        getData={getData}
          ...
          return (
            ...
            >
              ...
              >
                <div className={"flex items-center"}>
                  <span className={"truncate"}>{`${
                    item?.nameEn ?? labels.notAvailable
                  }`}</span>
                </div>
              </td>
              ...
              >
                <div className={"flex items-center"}>
                  <span className={"truncate"}>{`${
                    item?.nameAr ?? labels.notAvailable
                  }`}</span>
                </div>
              </td>
