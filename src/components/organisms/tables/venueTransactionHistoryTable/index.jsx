...
const VenueTransactionHistoryTable = ({
  pageData = {},
  setEdit = () => {},
  setShowDeleteModal = () => {},
}) => {
  ...
  const dummyTransactions = [
    {
      ...
      venueName: "Lily & Adam's Engagement Party",
      slots: [
        new Date("2024-08-10"),
        new Date("2024-08-11"),
        new Date("2024-08-12"),
  ...
  return (
    <div>
      <Table
        headers={labels?.venueTransactionHeader}
...
export default VenueTransactionHistoryTable;
