...
const MonetaryTransactionHistoryTable = ({
  pageData = {},
  setEdit = () => {},
  setShowDeleteModal = () => {},
}) => {
  ...
  const dummyTransactions = [
    {
      ...
      service: {
        type: "The Ballroom Hall",
      },
      total: "1100",
      eventName: "Lily & Adam's Engagement Party",
      invitationName: "The Ballroom Hall",
      slots: [
        new Date("2024-08-10"),
        new Date("2024-08-11"),
        new Date("2024-08-12"),
  ...
  return (
    <div>
      <Table
        headers={labels?.monetaryTransactionHeader}
        ...
        renderItem={(item, index, pageNumber) => {
          return (
            ...
            >
              ...
              <td
                className={`min-w-40 px-3 py-2 font-outfit_regular text-c_202224`}
              >
                <div className={"flex items-center gap-2"}>
                  <UserImage />
                  <span
              ...
              <td className='min-w-20 px-3 py-2'>
                <span className='font-outfit_regular truncate text-black'>
                  {`${item?.total} ${labels.omanCurrency}`}
                </span>
              </td>
              <td className='min-w-20 px-3 py-2'>
                <span className='font-outfit_regular truncate text-black'>
...
export default MonetaryTransactionHistoryTable;
